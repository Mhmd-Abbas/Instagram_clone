        ...
        <Fade in={open}>
          <Box sx={style} > 
            ...
            <Typography id="transition-modal-description"  color="primary" sx={{ mt: 2, display:"flex", justifyContent:"center", textAlign:"left", flexDirection:"column", padding:"10px"   }}>
                ...
                <br/>
                <label htmlFor='image-upload' style={{ width:"70%", marginLeft:"15%",  borderRadius:"15px"}} >
                  <Button component="span" variant='filled' sx={{ color:"white", backgroundColor:"CornflowerBlue", width:"100%", height:"30px", borderRadius:"15px", textTransform:"capitalize" }} >
                    Choose Image 
                  </Button>
                </label>
                <input
